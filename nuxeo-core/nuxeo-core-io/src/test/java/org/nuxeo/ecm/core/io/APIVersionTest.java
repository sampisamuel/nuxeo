...
public class APIVersionTest {
    ...
    public void testComparingAPIVersions() {
        APIVersion version = APIVersion.of(2);
        assertTrue(version.eq(APIVersion.V2));
        assertTrue(version.neq(APIVersion.V1));
        assertTrue(version.gt(APIVersion.V1));
        assertTrue(version.gte(APIVersion.V1));
        assertTrue(version.gte(APIVersion.V2));

        version = APIVersion.of(1);
        assertTrue(version.eq(APIVersion.V1));
        assertTrue(version.neq(APIVersion.V2));
        assertTrue(version.lt(APIVersion.V2));
        assertTrue(version.lte(APIVersion.V2));
